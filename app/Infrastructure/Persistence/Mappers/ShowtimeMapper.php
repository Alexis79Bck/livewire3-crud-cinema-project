...
/**
 * Mapper para convertir entre objetos de dominio Showtime y modelos Eloquent.
 *
 * Esta clase proporciona métodos estáticos para transformar objetos de dominio
 * Showtime (capa de dominio) a modelos Eloquent (capa de infraestructura) y
 ...
 *
 * @see Showtime Modelo de dominio
 * @see \App\Infrastructure\Persistence\Eloquent\Models\Showtime Modelo Eloquent
 */
